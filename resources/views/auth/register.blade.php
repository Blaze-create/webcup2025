...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .brand p{ margin:0; font-family:var(--mono); font-size:11px; color:rgba(242,242,242,.70); }
    ...
    .toggle:hover{ transform: translateY(-50%) translateY(-2px); background: rgba(242,242,242,.10); border-color: rgba(191,154,84,.35); }
    ...
    .hint.good{ color: rgba(242,242,242,.82); }
    .hint.bad{ color: rgba(242,242,242,.82); }
...
<body>
  ...
  <main>
    <section class="card" data-tilt id="card">
      <div class="cardTop">
        <div class="title">
          <strong>Create Your Operator ID</strong>
          <span>Secure credentials for the matchmaking console.<br/>Dieselpunk protocol compliant.</span>
        </div>
      ...
      <form id="form" method="post" action="{{ route('register') }}">
        ...
        <div class="row">
          ...
          <div class="inputWrap">
            <input id="name" name="name" type="text" placeholder="Operator name" autocomplete="name" required maxlength="80" />
          </div>
        ...
        <div class="row">
          ...
          <div class="inputWrap">
            <input id="password" name="password" type="password" placeholder="Min 8 chars • mix recommended" autocomplete="new-password" required />
        ...
        <div class="row">
          ...
          <div class="inputWrap">
            <input id="confirm" name="password_confirmation" type="password" placeholder="Re-enter password" autocomplete="new-password" required />
            <button class="toggle" type="button" id="toggleConfirm">SHOW</button>
          </div>
          <div class="hint" id="confirmHint"></div>
        </div>

        <div class="actions">
          <button class="btn" id="btnCreate" type="submit">Create Account</button>
