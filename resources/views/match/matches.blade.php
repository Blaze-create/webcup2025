      ...
      <section class="panel">
        ...
        <div class="body" id="list">
          ...
          <div class="match">
            ...
            <a class="btn" href="{{ route('chat.show',$user->id) }}">Open Chat</a>
          </div>
          @empty
      ...
      <aside class="panel">
        ...
        <div class="body">
          ...
          <div style="margin-top:12px; display:flex; gap:10px; flex-wrap:wrap;">
            ...
            <a class="btn" href="{{ route('match.page') }}" style="text-decoration:none; display:inline-flex; align-items:center;">Find More</a>
          </div>
        </div>
      </aside>
    </div>
